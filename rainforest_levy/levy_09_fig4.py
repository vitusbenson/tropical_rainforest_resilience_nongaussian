...
# %%
falseposrate = pd.read_csv("../data/share/falseposrate.csv", index_col=0)
# %%
...
sns.heatmap(falseposrate[falseposrate.only_negative_disturbances & falseposrate.add_short_timescale & (falseposrate.ews == "iqr") & (falseposrate.valid > 0.5)].pivot(index = "alpha", columns = "sigma", values = "p_kendalltau_adj"), vmin = 0.0, vmax = 0.25, cmap = "rocket_r", ax = axs[0], cbar=False, cbar_kws={"label": "False Positive Rate"})
...
sns.heatmap(falseposrate[falseposrate.only_negative_disturbances & falseposrate.add_short_timescale & (falseposrate.ews == "iqr") & (falseposrate.valid > 0.5)].pivot(index = "alpha", columns = "sigma", values = "p_kendalltau"), vmin = 0.0, vmax = 0.25, cmap = "rocket_r", ax = axs[1], cbar=True, cbar_kws={"label": "False Positive Rate"})
...
fig.tight_layout()
plt.savefig("../plots/fig4.pdf", dpi = 300, bbox_inches = "tight", transparent = True)
# %%
